...
def run_module():
    module_args = dict(
        ...
        bugzilla_product_name=dict(type='str', default='', required=False),
        valid_bug_states=dict(type='list', required=False),
        active=dict(type='bool', default=True, required=False),
        ftp_path=dict(type='str', default="", required=False),
        ftp_subdir=dict(type='str', required=False),
        internal=dict(type='bool', default=False, required=False),
        default_docs_reviewer=dict(type='str', default=None, required=False),
        push_targets=dict(type='list', required=True),
        default_solution=dict(type='str', required=True),
        state_machine_rule_set=dict(type='str', required=True),
        move_bugs_on_qe=dict(type='bool', default=False, required=False),
