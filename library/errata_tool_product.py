...
def run_module():
    module_args = dict(
        ...
        bugzilla_product_name=dict(default='', required=False),
        valid_bug_states=dict(type='list', required=False),
        active=dict(type='bool', default=True, required=False),
        ftp_path=dict(default="", required=False),
        ftp_subdir=dict(required=False),
        internal=dict(type='bool', default=False, required=False),
        default_docs_reviewer=dict(default=None, required=False),
