...
def run_module():
    module_args = dict(
        product=dict(type='str', default=None, required=False),
        ...
        program_manager=dict(type='str', required=True),
        blocker_flags=dict(type='list', default=[], required=False),
        internal_target_release=dict(type='str', default=None, required=False),
        zstream_target_release=dict(type='str', default=None, required=False),
        ship_date=dict(type='str', required=True),
        ...
        state_machine_rule_set=dict(type='str', default=None, required=False),
        pelc_product_version_name=dict(type='str', default=None,
                                       required=False),
